...
<div class="container">
    <!--<div>-->
    <!--    <script data-cfasync='false' type='text/javascript' src='//p235818.clksite.com/adServe/banners?tid=235818_447381_7&type=slider&size=120x600'></script>-->
    <!--</div>-->
  <div class="row" style="padding-bottom:30px;">
    <h3 class="text-center header-title">Match Criteria</h3>
  </div>
...
<script>
  ...
  <div class="col-md-6 ">
    <form class="" action="searchingplayer.php" method="post" name="myForm" onsubmit="return validateForm()">
      <?php if (mysqli_num_rows($sql_get) > 0): ?>
        ...
        <div class="form-group col-md-6">
          <label for="" class="label-top">Game time</label> <br>
          <label class="radio">
      ...
      <?php endif; ?>
      <input type="submit" name="submit" value="SEARCH PLAYERS" class="btn btn-block btn-orange" onclick="return CheckForm();">
    </form>
  </div>
  <div class="col-md-3">
